...
public class Vehicle {
    ...
    public Vehicle(String type, int numWheels){
        ...
        if ((type.equals("truck") && numWheels < 4) || (type.equals("motorcycle") && numWheels != 2)){
            throw new IllegalArgumentException("Illegal number of wheels");
        }
    ...
    // LAB EXERCISE #7.2  Vehicle TEST CONSTRUCTOR
...
// lmo online code checker only allows this: return "Illegal number of wheels";

    }
	
	
	// LAB EXERCISE #7.3  Vehicle COPY CONSTRUCTOR
    ...
    public Vehicle(Vehicle other) {
		...
		this.numWheels = other.getNumWheels();
    }
